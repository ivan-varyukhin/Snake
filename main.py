...
def start_the_game():
    ...
    snake_blocks = [SnakeBlock(random.randint(0, COUNT_BLOCKS - 1), random.randint(0, COUNT_BLOCKS - 1))]
...
menu_theme.set_background_color_opacity(0.4)

menu = pygame_menu.Menu('Змейка', 350, 300,
                       theme=menu_theme)
